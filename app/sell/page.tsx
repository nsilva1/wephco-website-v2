            ...
            <div className='flex flex-col items-center gap-8'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-3 gap-10'>
                    <div className='col-span-1 border border-gray-300 rounded-lg p-20'>
                        <h4 className='text-primary text-3xl md:text-4xl lg:text-5xl font-bold text-center'>240M+<br />impressions per month</h4>
                    </div>
                    <div className='col-span-1 border border-gray-300 rounded-lg p-20'>
                        <h4 className='text-primary text-3xl md:text-4xl lg:text-5xl font-bold text-center'>2M+<br />followers</h4>
                    </div>
                    <div className='col-span-1 border border-gray-300 rounded-lg p-20'>
                        <h4 className='text-primary text-3xl md:text-4xl lg:text-5xl font-bold text-center'>5B+<br />total impressions</h4>
                    </div>
                </div>
            </div>
        </section>
