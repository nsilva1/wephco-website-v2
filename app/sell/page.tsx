      ...
      <section className="p-10 font-outfit">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="col-span-1 flex flex-col items-center md:items-start justify-start gap-4">
            ...
            <p className="text-[#131316] dark:text-gray-400 text-sm md:text-base text-center md:text-start">
              Work with a dedicated WEPHCO agent who will listen to your needs
              and goals, use data and creativity to optimize your property for
              potential buyers, and stand beside you for every step of the
              selling process. We welcome expectations because we hold ourselves
              to the highest standard and know that our success is defined by
              yours. If you’re considering selling your home, or just want to
              get a sense of your home’s value, we would love to connect.
            </p>
          </div>
        </div>
      </section>
