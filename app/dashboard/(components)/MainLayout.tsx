    ...
    <PrivateRoute>
      <div className="flex h-screen bg-[#f8f9fa] text-slate-800 font-sans">
            ...
            {isCollapsed ? (
              ...
              <div className="flex items-center gap-3 w-full">
                ...
                <div className="flex flex-col">
                  <span className="font-bold text-lg tracking-wider text-slate-900 leading-none">
                    WEPHCO
                  </span>
                  <span className="text-[10px] text-[#cfb53b] font-semibold tracking-widest mt-1">
                    ADMIN PANEL
                  </span>
                </div>
              </div>
                      ...
                      <div
                        ...
                        {isCollapsed ? (
                          ...
                          <div className="flex items-center gap-4 w-full">
                            <item.icon
                              className={`text-xl ${isActive ? 'text-[#cfb53b]' : 'text-gray-400'}`}
                            />
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-3">
                ...
                <Link
                  ...
                  className="p-2.5 bg-white rounded-full cursor-pointer shadow-sm hover:bg-gray-200 transition-colors text-gray-600">
                  <Settings size={18} />
                </Link>
              </div>
              ...
              <div className="flex items-center gap-3 cursor-pointer">
                <div className="text-right hidden md:block">
                  ...
                  <p className="text-[10px] text-[#cfb53b] font-bold uppercase">
                    {user?.role ?? 'Admin'}
                  </p>
                </div>
          ...
          {/* Page Content */}
          <main className="flex-1 overflow-y-auto p-8 pt-4">{children}</main>
        </div>
      </div>
    </PrivateRoute>
  );
