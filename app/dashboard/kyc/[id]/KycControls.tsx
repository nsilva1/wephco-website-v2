...
export default function KycControls({
  userId,
  currentStatus,
}: KycControlsProps) {
        ...
        <Dialog open={isFlagModalOpen} onOpenChange={setIsFlagModalOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Describe the issue found with this user's KYC documents. The
                user will not be able to withdraw until the issue is resolved.
              </DialogDescription>
            </DialogHeader>
