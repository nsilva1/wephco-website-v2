...
export default async function CommissionPage() {
  ...
  // Summary stats
  const totalCommissionPaid = history.reduce(
    ...
    <div className="flex-1 space-y-6 p-4 md:p-8 pt-6">
      <div>
        ...
        <p className="text-slate-600 mt-1">
          Set rates, log commissions, and track credit history
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card className="bg-white">
          ...
          <CardContent>
            ...
            <p className="text-xs text-slate-500">Default for all agents</p>
          </CardContent>
        </Card>
        <Card className="bg-white">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            <p className="text-2xl font-bold text-slate-800">{uniqueAgents}</p>
            <p className="text-xs text-slate-500">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-bold text-slate-800">Commission History</h3>
