...
const LoginPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (
        ['SUPPORT', 'ADMIN', 'SUPERADMIN', 'MANAGER'].includes(
    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden font-display">
      ...
      <div className="relative z-10 w-full max-w-md px-6 py-12 mx-auto">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold tracking-widest text-slate-100 mb-1 uppercase">
            WEPHCO
          </h1>
        </div>
        ...
        <div className="bg-background-dark/50 backdrop-blur-xl border border-primary/15 p-8 rounded-xl shadow-2xl">
          ...
          <div className="mt-8 text-center pt-6">
            <p className="text-slate-400 text-xs">
              New to Wephco?
              <Link
                className="text-primary font-bold hover:text-primary/80 transition-colors ml-1 uppercase text-[10px] tracking-wider"
                href="/auth/register">
