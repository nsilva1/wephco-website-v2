  ...
  return (
    ...
    <div className='md:hidden'>
      <div className='flex flex-col gap-4'>
        <h2 className="text-wephco uppercase font-semibold text-center">Our Services</h2>
        <hr className="text-black w-full" />
        <h2 className="text-black text-xl font-bold my-8 text-center">{title}</h2>
        <p className="font-light mb-4 text-black text-center">{description}</p>
