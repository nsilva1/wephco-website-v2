...
export default function AffiliatesPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Your application has been submitted successfully! We will review it within 48 hours.');
  ...
  return (
    <div className="min-h-screen bg-background-dark text-slate-100 font-display pt-20">
      ...
      <section className="relative h-[550px] flex items-center justify-center px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl text-center space-y-6 mt-12 md:mt-0">
          ...
          <p className="text-base md:text-xl text-slate-300 max-w-2xl mx-auto font-light leading-relaxed">
            Partner with the region&apos;s most prestigious luxury real estate brand and elevate your career to unprecedented heights.
          </p>
          <div className="pt-6">
            <button 
      ...
      <section className="py-24 px-6 lg:px-20 bg-background-dark">
        <div className="max-w-7xl mx-auto">
          <div className="mb-16 text-center lg:text-left">
            <span className="text-primary text-xs font-bold tracking-widest uppercase block mb-3">Unrivaled Benefits</span>
            <h3 className="text-4xl font-light text-slate-100">
              Why Partner with <span className="font-extrabold text-primary">Wephco</span>?
            </h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-[#022618]/15 border border-primary/10 p-8 rounded-xl hover:border-primary/45 transition-all duration-300 group">
              ...
              <h4 className="text-lg font-bold text-slate-100 mb-3">Market Intelligence</h4>
              <p className="text-slate-400 leading-relaxed text-xs font-light">
                Access proprietary property valuation records and market performance data that optimize listing conversions.
              </p>
            </div>
            ...
            <div className="bg-[#022618]/15 border border-primary/10 p-8 rounded-xl hover:border-primary/45 transition-all duration-300 group">
              ...
              <h4 className="text-lg font-bold text-slate-100 mb-3">Global Network</h4>
              <p className="text-slate-400 leading-relaxed text-xs font-light">
                Secure access to high-net-worth property seekers across international finance hubs and gated enclaves.
              </p>
            </div>
            ...
            <div className="bg-[#022618]/15 border border-primary/10 p-8 rounded-xl hover:border-primary/45 transition-all duration-300 group">
              ...
              <h4 className="text-lg font-bold text-slate-100 mb-3">Premium Splits</h4>
              <p className="text-slate-400 leading-relaxed text-xs font-light">
                Enjoy industry-competitive commission splits alongside premium bonuses and milestone advisory incentives.
              </p>
            </div>
            ...
            <div className="bg-[#022618]/15 border border-primary/10 p-8 rounded-xl hover:border-primary/45 transition-all duration-300 group">
              ...
              <h4 className="text-lg font-bold text-slate-100 mb-3">Marketing Suite</h4>
              <p className="text-slate-400 leading-relaxed text-xs font-light">
                Deploy state-of-the-art cinematic listing photography and targeted digital outreach campaigns.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            ...
            <div className="relative z-10 text-center space-y-4">
              ...
              <p className="text-slate-400 text-xs leading-relaxed font-light">
                Submit your professional brokerage experience and profile record through our secure form below.
              </p>
            </div>
            ...
            <div className="relative z-10 text-center space-y-4">
              ...
              <p className="text-slate-400 text-xs leading-relaxed font-light">
                Collaborate with our executive desk to integrate listing tools, resource assets, and legal guidelines.
              </p>
            </div>
            ...
            <div className="relative z-10 text-center space-y-4">
              ...
              <p className="text-slate-400 text-xs leading-relaxed font-light">
                Leverage the premium Wephco brand identity to secure listing assets and close high-value deals.
              </p>
            </div>
      ...
      <section className="py-24 px-6 lg:px-20 bg-background-dark border-t border-primary/10" id="apply-form">
        <div className="max-w-5xl mx-auto flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="lg:w-1/2 space-y-6 text-center lg:text-left">
            <h3 className="text-4xl font-light text-slate-100 leading-tight">
              Ready to Take the <span className="font-extrabold text-primary">Next Step</span>?
            </h3>
            <p className="text-slate-400 leading-relaxed text-sm font-light">
              Our selection process focuses on integrity, local expertise, and alignment with our luxury service standards. We review all applications within 48 business hours.
            </p>
            
            <div className="space-y-4 pt-4 flex flex-col items-center lg:items-start">
              <div className="flex items-center gap-3 text-primary">
                <BiCheckCircle className="text-lg" />
                <span className="text-slate-200 text-sm font-medium">Exclusive Territory Access</span>
              </div>
              <div className="flex items-center gap-3 text-primary">
                <BiCheckCircle className="text-lg" />
              ...
              <div className="flex items-center gap-3 text-primary">
                <BiCheckCircle className="text-lg" />
                <span className="text-slate-200 text-sm font-medium">Professional Media Support</span>
              </div>
            </div>
          </div>

          <div className="lg:w-1/2 w-full">
            <form onSubmit={handleSubmit} className="bg-neutral-dark/30 border border-primary/15 p-8 md:p-10 rounded-2xl shadow-2xl backdrop-blur-md">
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-xs font-bold uppercase tracking-widest text-primary/80">Full Name *</label>
                    <input 
                      required
                      type="text"
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-bold uppercase tracking-widest text-primary/80">Experience (Years) *</label>
                    <input 
                      required
                      type="number"
                      placeholder="e.g. 5"
                ...
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-widest text-primary/80">Current Brokerage *</label>
                  <input 
                    required
                    type="text"
                ...
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-widest text-primary/80">Personal Message</label>
                  <textarea 
      ...
      <section className="bg-neutral-dark/10 text-slate-100 border-t border-primary/10">
        <div className="py-20 px-6 lg:px-20 max-w-7xl mx-auto flex flex-col items-center text-center space-y-8">
          <h2 className="text-3xl md:text-4xl font-light">
            Start Your Journey with <span className="font-extrabold text-primary">Wephco</span>
          </h2>
          <p className="text-slate-400 max-w-xl mx-auto text-sm font-light leading-relaxed">
            Be more than just an agent. Become a partner in shaping the future of global luxury real estate.
          </p>
