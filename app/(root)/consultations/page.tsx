        ...
        <div
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-slate-300 text-sm md:text-lg max-w-2xl mx-auto leading-relaxed">
              Experience tailormade real estate advisory configured to your
              unique lifestyle and investment goals. Our elite advisory partners
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-slate-400 flex items-center gap-2">
                          <Calendar className="size-4 text-primary" /> Select
                          Date
                        </label>
                        <input
                          name="meetingDate"
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-slate-400 flex items-center gap-2">
                          <MapPin className="size-4 text-primary" /> Meeting
                          Channel
                        </label>
                        <select
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-slate-400 flex items-center gap-2">
                          <User className="size-4 text-primary" /> Contact
                          Preference
                        </label>
                        <select
              ...
              <div className="space-y-6">
                  ...
                  <ul className="space-y-5">
                    <li className="flex gap-3.5">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-400 mt-1 leading-relaxed">
                          A deep dive into current inventory and off-market
                          opportunities.
                        </p>
                      </div>
                    </li>
                    <li className="flex gap-3.5">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-400 mt-1 leading-relaxed">
                          Full confidentiality regarding your identity and
                          investment goals.
                        </p>
                      </div>
                    </li>
                    <li className="flex gap-3.5">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-400 mt-1 leading-relaxed">
                          Personalized strategy for your acquisition or
                          divestment needs.
                        </p>
                      </div>
                    </li>
                ...
                <div className="bg-primary/5 rounded-xl p-5 border border-primary/10">
                  <h4 className="text-xs font-bold mb-2 flex items-center gap-2 text-slate-200">
                    <Phone className="size-3.5 text-primary" /> Immediate
                    Assistance?
                  </h4>
                  <p className="text-[11px] text-slate-400 mb-3">
                    Our concierge is available for urgent inquiries.
                  </p>
                  <a
