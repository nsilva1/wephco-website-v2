    ...
    <main className={layout.columnSection}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        ...
        <div className="border-b border-gray-200 pb-6 mb-8 text-center">
          <h1 className={typography.heading2}>PRIVACY POLICY</h1>
        ...
        <section className="mb-10">
          <p className={typography.paragraph}>
            This Privacy Policy explains how WEPHCO ("we," "us," or "our")
            collects, uses, discloses, and protects your personal information
            when you visit our website: www.wephco.com (the “Website”).
          </p>
          <p className={typography.paragraph}>
            By using the Website, you agree to the terms of this Privacy Policy.
            If you do not agree, please do not use our services or this Website.
          </p>
        </section>
        ...
        <div className="space-y-12">
          <section>
            ...
            <p className={typography.paragraph}>
              WEPHCO is a real estate and investment brokerage firm offering
              property marketing, sales, leasing, acquisitions, and investment
              advisory services in Nigeria and internationally.
            </p>
          </section>
          ...
          <section>
            ...
            <p className={typography.paragraph}>We use your information to:</p>
            <ul
              className={
                typography.paragraph + ' list-disc list-inside space-y-2 pl-4'
              }>
              ...
              <li>
                Provide updates about our properties or investment opportunities
              </li>
          ...
          <section>
            ...
            <ul
              ...
              <li>
                Business partners or affiliates where necessary for service
                fulfillment (e.g. property developers, agents, consultants)
              </li>
            </ul>
            <p className={typography.paragraph}>
              All third-party partners are required to protect your data in
          ...
          <section>
            ...
            <p className={typography.paragraph}>
              ...
              functionality of our website and understand user behavior. You can
              control or delete cookies through your browser settings. Please
          ...
          <section>
            ...
            <p className={typography.paragraph}>
              Our Website is not directed at children under 18. We do not
          ...
          <section>
            ...
            <p className={typography.paragraph}>
              ...
              use of our Website after such updates constitutes your acceptance
