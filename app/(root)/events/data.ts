...
export const MOCK_EVENTS: EventItem[] = [
  {
    ...
    agenda: [
      {
        time: '06:00 PM',
        title: 'Arrival & Welcome Cocktails',
        description:
          'Champagne reception and networking at the Sky Residence Lounge.',
      },
      {
        time: '06:45 PM',
        title: 'Guided Architectural Showcase',
        description:
          'Walkthrough of key penthouses and custom interior portfolios.',
      },
      {
        time: '07:30 PM',
        title: 'Private Dinner & Presentation',
        description:
          'A gourmet dining experience paired with detailed asset overview.',
      },
      {
        time: '09:00 PM',
        title: 'Advisory & Reservation Sessions',
        description:
          'Private contract discussions and property reservation clearances.',
      },
    ],
    hosts: [
      {
  ...
  },
  {
    ...
    description:
      'Immersive investment roundtable highlighting high-yield off-market duplexes in Dubai Marina and Palm Jumeirah. Includes private one-on-one portfolio consulting.',
    longDescription:
    ...
    agenda: [
      {
        time: '11:00 AM',
        title: 'Morning Portfolios Review',
        description:
          'Initial introductions and high-level market statistics outline.',
      },
      {
        time: '12:00 PM',
        title: 'Golden Visa & Tax Seminar',
        description:
          'Briefing on the legal frameworks for Dubai residency & tax protections.',
      },
      {
        time: '01:30 PM',
        title: 'VIP Networking Lunch',
        description:
          'Informal discussions with Dubai asset managers over lunch.',
      },
      {
        time: '03:00 PM',
        title: 'One-on-One Wealth Structuring',
        description:
          'Individual consultations to match specific investor criteria.',
      },
    ],
    hosts: [
      {
        ...
        image:
          'https://lh3.googleusercontent.com/aida-public/AB6AXuBiYgl6z_tCyRQO2aZHFj_dfmPmGbYm_40xlssUe7r1hmCqPNxbl06neTpcT9QqrwjkkTlp2mEIW2Zy2nI8WSzbfsCDY1OHKfzdCJMXbi2HjSc2Gz502sBr6pJkaUQmli4WOFe4DrKIz_6-Z30w-fYOpj_OqGg3X-oDRKjTSOVGf5CxzzNCGqmyGZ6i_G4ll0MpS_N23x1rQlXQ0_gXNItquXFtWztc6MMVepVmBiNGguwnSj5H5Ge2_1VyF_1SYPcx-hoPuDFbH9XY',
      },
    ],
  },
  {
    ...
    description:
      'Join our digital concierge for a live, highly detailed 3D walkthrough of a private oceanside sanctuary in Clifton, Cape Town. Live Q&A with luxury asset managers.',
    longDescription:
    ...
    agenda: [
      {
        time: '02:00 PM',
        title: 'Digital Broadcast Kickoff',
        description: 'Introduction to Wephco’s Cape Town luxury portfolio.',
      },
      {
        time: '02:15 PM',
        title: 'Immersive Spatial Walkthrough',
        description: 'Live virtual navigation through Clifton beachside villa.',
      },
      {
        time: '02:45 PM',
        title: 'Market Integration & Yields',
        description:
          'Reviewing historical capital appreciation and short-let averages.',
      },
      {
        time: '03:15 PM',
        title: 'Interactive Q&A Session',
        description:
          'Answering questions regarding management, operations, and transfer.',
      },
    ],
    hosts: [
      {
  ...
  },
  {
    ...
    description:
      'Wephco’s premier European showcase exhibiting ultra-luxury residential assets across Mayfair, Belgravia, and Knightsbridge, London. Completed with exceptional investor turnouts.',
    longDescription:
