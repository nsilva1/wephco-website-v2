...
export function PrivateRSVPModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(
        'Your VIP invitation request has been submitted successfully! Our concierge team will reach out to you shortly.'
      );
        ...
        <div className="p-6 md:p-8 space-y-6">
          <div className="space-y-1.5 text-center md:text-left">
            <span className="inline-flex items-center gap-1 text-[10px] font-bold tracking-widest text-primary uppercase">
              <Award className="size-3 text-primary animate-pulse" /> VIP
              Invitation Request
            </span>
            ...
            <p className="text-xs text-slate-400">
              Apply for private access. Invitation decisions are compiled within
              24 hours.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
              <label className="text-xs font-semibold text-slate-400">
                Target Portfolio Range / Investment Tier
              </label>
              <select
