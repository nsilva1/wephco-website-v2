      ...
      <section className="relative w-full min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-6 max-w-4xl mx-auto mt-12 md:mt-0">
          <h1 className="text-white text-5xl md:text-7xl font-light leading-tight mb-6 tracking-tight">
            Bespoke{' '}
            <span className="text-primary font-black italic">Real Estate</span>{' '}
            Services
          </h1>
          <p className="text-slate-300 text-base md:text-lg font-light mb-10 max-w-2xl mx-auto leading-relaxed">
            Experience the pinnacle of luxury property management and private
            advisory tailored for the world&apos;s most discerning individuals.
          </p>
        ...
        <div className="max-w-7xl mx-auto space-y-24">
          ...
          <div>
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 gap-4 border-b border-primary/10 pb-6">
              ...
              <p className="text-slate-400 text-xs italic">
                Connecting wealth with high-value prime global assets.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {wephcoServices.international.map((service, idx) => (
                <div
                  key={idx}
                  className="bg-neutral-dark/20 p-8 rounded-2xl border border-primary/10 hover:border-primary/30 transition-all duration-300 flex gap-5 items-start">
                  <div className="bg-primary/15 text-primary p-3.5 rounded-xl shrink-0">
                    <BiGlobe className="text-2xl" />
                  </div>
                  <div className="space-y-2">
                    <h4 className="text-slate-100 text-lg font-bold">
                      {service.title}
                    </h4>
          ...
          <div>
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 gap-4 border-b border-primary/10 pb-6">
              ...
              <p className="text-slate-400 text-xs italic">
                Unmatched security, management, and positioning within Nigeria.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {wephcoServices.local.map((service, idx) => (
                <div
                  key={idx}
                  className="bg-neutral-dark/20 p-6 rounded-2xl border border-primary/10 hover:border-primary/30 transition-all duration-300 flex flex-col justify-between">
          ...
          <div>
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 gap-4 border-b border-primary/10 pb-6">
              <div>
                ...
                <h3 className="text-slate-100 text-3xl font-light">
                  Consultation &amp;{' '}
                  <span className="font-extrabold text-primary">Advisory</span>
                </h3>
              </div>
              <p className="text-slate-400 text-xs italic">
                Private structuring and strategic acquisition planning.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2">
            <h2 className="text-slate-100 text-4xl md:text-5xl font-light mb-8 leading-tight">
              The Wephco{' '}
              <span className="text-primary font-extrabold">Advantage</span>
            </h2>
            <p className="text-slate-400 text-base mb-12 leading-relaxed font-light">
              Redefining excellence in luxury real estate with a client-first
              framework. Our approach combines traditional values with modern
              global insights.
            </p>
            ...
            <div className="space-y-8">
              <div className="flex gap-6 items-start">
                ...
                <div>
                  <h4 className="text-slate-100 text-lg font-bold mb-2">
                    White-Glove Service
                  </h4>
                  <p className="text-slate-400 text-sm leading-relaxed">
                    Every detail is carefully managed from first view to legal
                    close. We provide a completely seamless, stress-free
                    brokerage cycle.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6 items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm leading-relaxed">
                    Complete confidentiality, off-market transaction access, and
                    structural security representing your family holdings.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h3 className="text-slate-100 text-4xl md:text-5xl font-light mb-6">
              Voices of{' '}
              <span className="font-extrabold text-primary">Distinction</span>
            </h3>
            <p className="text-slate-400 max-w-2xl mx-auto italic text-sm leading-relaxed">
              Hear from global leaders and legacy builders who have entrusted
              their portfolios to our guidance.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-neutral-dark/20 p-8 rounded-2xl border border-primary/10 flex flex-col h-full hover:border-primary/30 transition-all duration-300">
              ...
              <p className="text-slate-300 text-sm leading-relaxed mb-8 italic grow">
                &quot;The discretion and deep market insight provided are
                unparalleled. They secured an off-market property that perfectly
                matched my lifestyle objectives.&quot;
              </p>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-primary text-[10px] uppercase tracking-wider font-semibold">
                    CEO, Sterling Global
                  </p>
                </div>
              </div>
            ...
            <div className="bg-neutral-dark/20 p-8 rounded-2xl border border-primary/10 flex flex-col h-full hover:border-primary/30 transition-all duration-300 md:translate-y-4">
              <BiSolidQuoteLeft className="text-primary text-4xl mb-6 shrink-0" />
              <p className="text-slate-300 text-sm leading-relaxed mb-8 italic grow">
                &quot;The client-care isn&apos;t just a promise; it&apos;s their
                standard. Every detail of our international asset relocation was
            ...
            <div className="bg-neutral-dark/20 p-8 rounded-2xl border border-primary/10 flex flex-col h-full hover:border-primary/30 transition-all duration-300">
              <BiSolidQuoteLeft className="text-primary text-4xl mb-6 shrink-0" />
              <p className="text-slate-300 text-sm leading-relaxed mb-8 italic grow">
                &quot;A masterclass in wealth advisory. Their ability to acquire
                off-market placements in highly competitive climates is why they
                remain our only option.&quot;
              </p>
              <div className="flex items-center gap-4">
                <div className="size-12 rounded-full overflow-hidden border border-primary/30 relative">
                  <Image
      ...
      <section className="py-24 px-6 md:px-20 text-center relative overflow-hidden bg-background-dark border-t border-primary/10">
        <div className="max-w-3xl mx-auto relative z-10">
          <h2 className="text-slate-100 text-4xl md:text-5xl font-light mb-6 leading-tight">
            ...
            <span className="font-extrabold text-primary">Journey</span>
          </h2>
