        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="col-span-1">
            <p className="text-gray-600 font-mono text-sm lg:text-lg">
              Don't just join another brokerage; become part of a revolution.
              The WEPHCO Difference is an ecosystem designed for ambitious,
              driven, and forward-thinking luxury real estate agents like you.
              The future of real estate is here—don't miss your opportunity to
              be a part of it.
            </p>
          </div>
        </div>
      ...
      <section className="py-20 px-10 font-outfit">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="col-span-1 flex flex-col gap-8">
            ...
            />
            <AgentPerkItem
              title="Save Hours Per Week with State-of-the-Art Tech & Talented Advisors"
              description="Why let cumbersome processes eat away your valuable time? Our state-of-the-art technology cuts hours off your workflow. Spend your time where it matters most: closing deals and providing exceptional service. At WEPHCO, our technology and people serve you, not the other way around."
            />
            <AgentPerkItem
              title="Build a World-Class Brand & Amplify Your Real Estate Following"
              description="Back your brand and your business with a full-service creative workshop, an award-winning cinema-quality content studio, and the proven formulas and modern strategies that built the most followed real estate brand on the planet. Supercharge your reach, capitalize on shifting consumer trends to social media, and establish yourself as a leading voice in your market and on the global stage."
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-10 font-outfit">
        <div className="flex flex-col-reverse md:grid md:grid-cols-2 gap-12 my-20">
          <div className="col-span-1 flex flex-col gap-10">
            <AgentPerkItem
              title="Increase Your Earning Potential at WEPHCO."
              description="Discover your true earning potential at WEPHCO, where agents earn on average four times more than industry standards. You're not just an agent; you're a business. We recognize that and invest in your success, making your profitability our priority."
            />
            <Link
              href="#agent-form"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 my-20">
          ...
          <div className="col-span-1 flex flex-col gap-10">
            <AgentPerkItem
              title="Join a Network of Over 1,000 Like-Minded Agents"
              description="Join a network of over 1,000 agents who are shaping the future of real estate. Our proven models and systems aren't just theories—they're practices that have stood the test of success. Here, mentorship is mutual, and wisdom is shared. It's not just about individual success; it's about collective growth."
            />
            <Link
              href="#agent-form"
              className="bg-wephco text-white py-2 px-3 w-full md:w-28 rounded-full flex items-center justify-between">
