...
const WepchoTermsOfService = () => {
  return (
    <main className="bg-white dark:bg-black text-gray-800 font-outfit">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        ...
        <section className="mb-10">
          ...
          <p className="mt-4 text-lg leading-relaxed text-gray-700 dark:text-gray-500">
        ...
        <div className="space-y-12">
          ...
          <section>
            <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 dark:text-white mb-4 border-l-4 border-blue-600 pl-4">
              1. Who We Are
            </h2>
            <p className="leading-relaxed text-gray-700 dark:text-gray-500">
          ...
          <section>
            ...
            <p className="mb-4 leading-relaxed text-gray-700 dark:text-gray-500">
              By using www.wephco.com, you agree to:
            </p>
            <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-500 leading-relaxed pl-4">
          ...
          <section>
            ...
            <p className="mb-4 leading-relaxed text-gray-700 dark:text-gray-500">You may not:</p>
            <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-500 leading-relaxed pl-4">
          ...
          <section>
            ...
            <p className="mb-6 leading-relaxed text-gray-700 dark:text-gray-500">
