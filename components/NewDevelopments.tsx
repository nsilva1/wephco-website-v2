  ...
  return (
    <section className='p-8'>
      <div className='text-center lg:text-left mb-8'>
        <h2 className='text-4xl font-bold mb-4 text-primary lg:text-5xl'>The Boldest New<br />Developments</h2>
        <p className='mb-8'>Explore our transformative new projects that elevate modern luxury living.</p>
      </div>
